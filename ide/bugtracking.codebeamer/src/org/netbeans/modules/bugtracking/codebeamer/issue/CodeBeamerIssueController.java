...
/**
 * TODO - provides the UI for your particular issue instance and 
 * handles interaction with the TopComponent in which it is visualized.
 * 
 * @author tomas
 */
class CodeBeamerIssueController implements IssueController, DocumentListener, ActionListener {
    private final CodeBeamerIssue issue;
    
    private CodeBeamerIssuePanel panel;
    private final PropertyChangeSupport support = new PropertyChangeSupport(this);
    
    public CodeBeamerIssueController(CodeBeamerIssue issue) {
        this.issue = issue;
    }

    @Override
    public CodeBeamerIssuePanel getComponent() {
        if(panel == null) {
            panel = new CodeBeamerIssuePanel();
